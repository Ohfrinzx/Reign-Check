# Archived project status history (up to 2026-09-23)

**History, not instructions.** These are every earlier "WHERE WE STOPPED"
handover, newest first, then the original Phase 1 handover (sections 1–8).
Much of it is out of date: 30-day runs, the old vote, "not started" notes
for things that are now done. **For the current state, read
`PROJECT_STATUS.md`, `AGENTS.md` and `docs/SYSTEMS.md`.**
