 ...
 *  crisis chains. 12→13: ConfidenceVoteResult counts faction blocs
 *  (blocs/debtCost), for balance slice B. 13→14: lastOutcome.because/
 *  marked, for balance slice C's consequences (marks live in flags). */
