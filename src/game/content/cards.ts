    ...
    },
    {
      ...
      outcome: {
        ...
        effects: {
          ...
          promise: { id: 'helicopter', text: '$9B for the helicopter programme, promised to the army', to: 'staff', inDays: 5 },
    ...
    },
    {
      ...
      outcome: {
        ...
        effects: {
          ...
          promise: { id: 'hadem-road', text: 'The third road into the Hadem region', to: 'provinces', inDays: 7 },
        ...
        return accept
          ? {
              ...
              effects: {
                ...
                promise: { id: 'lithium-wages', text: 'Lithium-linked wage top-up for the unions', to: 'combine', inDays: 8 },
  ...
  options: [
    {
      ...
      outcome: {
        ...
        effects: {
          ...
          commitments: [{ label: 'Helicopter programme', perDay: 0.35, days: 12 }],
          resolvePromise: { id: 'helicopter', status: 'kept' },
        },
      },
    },
    {
      ...
      outcome: {
        ...
        effects: {
          ...
          deferPromise: { id: 'helicopter', inDays: 6 },
    ...
    },
    {
      ...
      outcome: {
        ...
        effects: {
          ...
          resolvePromise: { id: 'helicopter', status: 'broken' },
